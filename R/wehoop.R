...
### **Women's college basketball full play-by-play seasons (2004-2021) ~ 45-90 seconds**
tictoc::tic()
progressr::with_progress({
...
### **Women's college basketball full team box score seasons (2006-2021) ~ 5-30 seconds**
tictoc::tic()
progressr::with_progress({
...
### **Women's college basketball full player box score seasons (2006-2021) ~ 5-30 seconds**
